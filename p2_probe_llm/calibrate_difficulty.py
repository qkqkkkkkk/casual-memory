...
from .run_experiment_e1 import _evidence_texts, load, placebo, retrieve, select_claims
...
def main() -> None:
    ...
    for recall in recalls:
        ...
        for claim in sampled:
            ...
            candidates = {aid: retrieve(variant, experience_bank, aid, args.top_k, index) for aid in ("A1", "A2", "A3")}
    ...
    report = {"experiment": "fever_difficulty_calibration", "model": args.model, "target_band": [.62, .80], "target_center": .70, "selected": selected, "conditions": rows, "llm_calls": client.calls, "cache_hits": client.cache_hits, "experience_bank": str(args.experience_bank), "distractor_bank": str(args.distractor_bank), "pass": selected is not None}
